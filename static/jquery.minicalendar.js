...
function printType(thisYear, thisMonth) {
    ...
    function printTD(count, col) {
        ...
        return '<td' + tmpId + '><a href="/menu?date=' + thisYear + ("0" + thisMonth).slice(-2) + ("0" + count).slice(-2) + '"><i class="calendar-day-number">' + count + '</i><div class="calendar-labels">' + dayText + '</div></a></td>';
    }
